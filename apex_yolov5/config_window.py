...
class ConfigWindow(QMainWindow):
    def __init__(self, config):
        ...
        self.mouse_config_layout = MouseConfigLayout(self.config, self, self.config_layout)
        self.auto_gun_config_layout = AutoGunConfigLayout(self.config, self, self.config_layout)
        self.auto_save_config_layout = AutoSaveConfigLayout(self.config, self, self.config_layout)
        self.auto_charge_energy_layout = AutoChargedEnergyLayout(self.config, self, self.config_layout)
        self.screenshot_layout = ScreenshotAreaLayout(self.config, self, self.config_layout)
        self.initUI()
    ...
    def initUI(self):
        ...
        container = QWidget()
        container.setLayout(self.config_layout)
